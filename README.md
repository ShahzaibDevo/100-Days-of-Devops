...
2. Go back to Jenkins → database-backup job
3. A new build should appear automatically in **Build History**
4. Verify it completes successfully
5. Check that the backup file is updated or a new one is created

### Step 7: Final Verification Checklist

- ✅ Jenkins job named `database-backup` created
- ✅ Build triggers configured with schedule `*/10 * * * *`
- ✅ Manual build runs successfully
- ✅ Console output shows "BACKUP COMPLETED SUCCESSFULLY"
- ✅ Console output shows "Finished: SUCCESS"
- ✅ Backup file exists on stbkp01 at `/home/clint/db_backups/`
- ✅ Backup filename follows format `db_YYYY-MM-DD.sql`
- ✅ Backup file size is greater than 0 (44K in this case)
- ✅ Automatic builds run every 10 minutes
